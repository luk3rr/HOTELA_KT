...
public class RestExceptionHandler {
    private static final Map<Class<? extends HotelaException>, HttpStatus> STATUS_MAP =
            Map.ofEntries(
                    Map.entry(
                            HotelaException.CustomerNotFoundException.class, HttpStatus.NOT_FOUND),
                    ...
                    Map.entry(
                            HotelaException.InvalidCredentialsException.class,
                            HttpStatus.UNAUTHORIZED),
                    Map.entry(
                            HotelaException.InvalidOrExpiredTokenException.class,
                            HttpStatus.UNAUTHORIZED),
                    Map.entry(
                            HotelaException.EmailAlreadyRegisteredException.class,
                            HttpStatus.CONFLICT),
                    Map.entry(
                            HotelaException.BookingAlreadyCancelledException.class,
                            HttpStatus.CONFLICT),
